...
const pageTitles = {
    '/': 'Александр Львович Овчинников — художник',
    '/artist': 'О художнике — Александр Львович Овчинников',
    '/exhibition': 'Архив выставки «Пространство памяти» — Александр Овчинников',
    '/works': 'Работы — Александр Львович Овчинников',
    '/digital': 'Темы и цифровой архив — Александр Львович Овчинников',
    '/digital/workshop': 'Графика и мастерская — Александр Львович Овчинников',
    '/digital/animated': 'Маршруты и ожившие полотна — Александр Львович Овчинников',
    '/visit': 'Выставка «Пространство памяти», 2026 — архив посещения',
    '/contacts': 'Книга памяти и контакты — Александр Львович Овчинников'
};
...
function getWorkTitle(slug) {
    ...
    return work ? `${work.title} — Александр Львович Овчинников` : 'Работа — Александр Львович Овчинников';
}
